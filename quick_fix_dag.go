// Быстрое решение: создадим DAG файл напрямую без компиляции проблемной функции
...
func main() {
	fmt.Println("Создаю исправленный DAG файл...")

	// Создаем простой работоспособный DAG файл
	dagContent := `"""
...
`
	...
	// Записываем файл
	dagFile := "ops/airflow/dags/test_generated_fixed.py"
	...
	fmt.Printf("✅ DAG файл создан: %s\n", dagFile)
	fmt.Println("Теперь проверьте Airflow UI для появления нового DAG!")
}
